    ...
    var response = 
        ...
        [
            ...
            "OWASP API Security API5:2023 - Broken Function Level Authorisation",
                "Can users perform sensitive actions?",
                "Users should not have access to simply change HTTP methods",
                "Invoke consistent and easy to analyse authorisation for all business functions."   
        ]);
